...
Hero: Hazem Fadel the Mage
Student ID: 16001349
GitHub account: hazemfadel12123-droid

A **Sphinx Wraith** bars the way near **Luxor's temples**. It only falls to
the exact blow.
...
1. Your hero name
2. Your student ID
3. Your power — your student ID **multiplied by 3**
4. Your warcry — copy the line below exactly, including punctuation:

   "By Luxor's temples, the Sphinx Wraith falls!"
